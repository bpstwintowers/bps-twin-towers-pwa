...
const FESTIVAL_EVENTS_14_TO_19: FestivalEventItem[] = [
  ...
  // ==========================================
  // DAY 2: 15th Sep 2026 (Tuesday)
  // ==========================================
  {
    id: 'day2-morning-pooja',
    dayNumber: 2,
    dayLabel: 'Day 2 • Tue, 15th Sep',
    dateKey: 'sep15',
    month: 'SEP',
    day: '15',
  ...
  },
  {
    ...
    rituals: ['Vocal Seva'],
    spocName: 'K. Srinivasan (A-402)',
    spocPhone: '+91 98451 23456',
    attendeesCount: 120,
    hasShareBtn: true,
  },
  {
  ...
  // ==========================================
  // DAY 3: 16th Sep 2026 (Wednesday)
  // ==========================================
  {
    id: 'day3-morning-homam',
    dayNumber: 3,
    dayLabel: 'Day 3 • Wed, 16th Sep',
    dateKey: 'sep16',
    month: 'SEP',
    day: '16',
  ...
  },
  {
    ...
    rituals: ['Cultural Drama & Dance'],
    spocName: 'Cultural Committee',
    attendeesCount: 220,
    hasShareBtn: true,
  },
  {
  ...
  // ==========================================
  // DAY 4: 17th Sep 2026 (Thursday)
  // ==========================================
  {
    id: 'day4-morning-chanting',
    dayNumber: 4,
    dayLabel: 'Day 4 • Thu, 17th Sep',
    dateKey: 'sep17',
    month: 'SEP',
    day: '17',
    ...
    rituals: ['Sahasra Avartana', 'Panchamrutham', 'Swarna Pushpa Archana'],
    naivedyam: 'Chakkara Pongal, Pulihora, Payasam',
    attendeesCount: 170,
    hasShareBtn: true,
  },
  {
    ...
    rituals: ['Community Tiffin Feast'],
    attendeesCount: 250,
    hasShareBtn: true,
  },

  // ==========================================
  // DAY 5: 18th Sep 2026 (Friday)
  // ==========================================
  {
    id: 'day5-morning-pooja',
    dayNumber: 5,
    dayLabel: 'Day 5 • Fri, 18th Sep',
    dateKey: 'sep18',
    month: 'SEP',
    day: '18',
    ...
    rituals: ['Gothra Nama Sankalpam', '1008 Bilva Patra', 'Ksheera Abhishekam'],
    attendeesCount: 230,
    hasShareBtn: true,
  },
  {
    ...
    rituals: ['1008 Diya Deepotsavam', 'Grand Laddu Auction', 'Maha Aarti'],
    attendeesCount: 300,
    hasShareBtn: true,
  },
  {
    ...
    rituals: ['Royal Community Dining'],
    attendeesCount: 290,
    hasShareBtn: true,
  },

  // ==========================================
  // DAY 6: 19th Sep 2026 (Saturday)
  // ==========================================
  {
    id: 'day6-morning-pooja',
    dayNumber: 6,
    dayLabel: 'Day 6 • Sat, 19th Sep',
    dateKey: 'sep19',
    month: 'SEP',
    day: '19',
    ...
    rituals: ['Uttarapooja', 'Punah Avahana', 'Pushpanjali', 'Maha Harathi'],
    attendeesCount: 260,
    hasShareBtn: true,
  },
  {
    ...
    rituals: ['Shobha Yatra', 'Nasik Dhol', 'Eco Visarjan'],
    attendeesCount: 350,
    hasShareBtn: true,
  },
  {
